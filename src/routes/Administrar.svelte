      ...
      <div class="col-md-8">
        ...
        {#each combos as combo}
         <div class="edicion">
            ...
            <div class="botones">
               <button on:click={deleteCombo(combo.id)} class="btn btn-danger">Borrar</button>
               <button class="btn btn-success" style="vertical-align:middle" on:click={editCombo(combo)}>Editar</button>
            </div>
          </div>
        {/each}
         </div>
